...
import static sample.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static sample.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static sample.test.util.OAuth2TestUtil.testAuthenticationToken;
