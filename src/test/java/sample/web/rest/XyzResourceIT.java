...
class XyzResourceIT {
    ...
    private static final String DEFAULT_UNIQUE_FIELD = "AAAAAAAAAA";
    private static final String UPDATED_UNIQUE_FIELD = "BBBBBBBBBB";

    private static final String DEFAULT_ANOTHER_FIELD = "AAAAAAAAAA";
    private static final String UPDATED_ANOTHER_FIELD = "BBBBBBBBBB";
    ...
    public static Xyz createEntity(EntityManager em) {
        Xyz xyz = new Xyz().uniqueField(DEFAULT_UNIQUE_FIELD).anotherField(DEFAULT_ANOTHER_FIELD);
        return xyz;
    }
    ...
    public static Xyz createUpdatedEntity(EntityManager em) {
        Xyz xyz = new Xyz().uniqueField(UPDATED_UNIQUE_FIELD).anotherField(UPDATED_ANOTHER_FIELD);
        return xyz;
    }
    ...
    void createXyz() throws Exception {
        ...
        assertThat(testXyz.getUniqueField()).isEqualTo(DEFAULT_UNIQUE_FIELD);
        assertThat(testXyz.getAnotherField()).isEqualTo(DEFAULT_ANOTHER_FIELD);
    }
    ...
    @Test
    @Transactional
    void checkUniqueFieldIsRequired() throws Exception {
        int databaseSizeBeforeTest = xyzRepository.findAll().size();
        // set the field null
        xyz.setUniqueField(null);
    ...
    void getAllXyzs() throws Exception {
        ...
        restXyzMockMvc
            ...
            .andExpect(jsonPath("$.[*].uniqueField").value(hasItem(DEFAULT_UNIQUE_FIELD)))
            .andExpect(jsonPath("$.[*].anotherField").value(hasItem(DEFAULT_ANOTHER_FIELD)));
    }
    ...
    void getXyz() throws Exception {
        ...
        restXyzMockMvc
            ...
            .andExpect(jsonPath("$.uniqueField").value(DEFAULT_UNIQUE_FIELD))
            .andExpect(jsonPath("$.anotherField").value(DEFAULT_ANOTHER_FIELD));
    }
    ...
    void putNewXyz() throws Exception {
        ...
        updatedXyz.uniqueField(UPDATED_UNIQUE_FIELD).anotherField(UPDATED_ANOTHER_FIELD);
        ...
        Xyz testXyz = xyzList.get(xyzList.size() - 1);
        assertThat(testXyz.getUniqueField()).isEqualTo(UPDATED_UNIQUE_FIELD);
        assertThat(testXyz.getAnotherField()).isEqualTo(UPDATED_ANOTHER_FIELD);
    }
    ...
    void fullUpdateXyzWithPatch() throws Exception {
        ...
        partialUpdatedXyz.uniqueField(UPDATED_UNIQUE_FIELD).anotherField(UPDATED_ANOTHER_FIELD);
