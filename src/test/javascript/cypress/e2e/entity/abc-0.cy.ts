...
describe('Abc0 e2e test', () => {
  ...
  const abc0Sample = { name: 'Unbranded e-services' };
  ...
  describe('Abc0 page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('edit button click should load edit Abc0 page and go back', () => {
      ...
      it('edit button click should load edit Abc0 page and save', () => {
        cy.get(entityEditButtonSelector).first().click();
        cy.getEntityCreateUpdateHeading('Abc0');
  ...
  describe('new Abc0 page', () => {
    ...
    it('should create an instance of Abc0', () => {
      cy.get(`[data-cy="name"]`).type('Team-oriented Loan Berlin').should('have.value', 'Team-oriented Loan Berlin');

      cy.get(`[data-cy="otherField"]`).type('Phased Nepal Extensions').should('have.value', 'Phased Nepal Extensions');
